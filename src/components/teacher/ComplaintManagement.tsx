...
import { AlertCircle, MessageSquare, Clock, CheckCircle, Send } from 'lucide-react';
  ...
  const complaints = [
    {
      ...
      status: 'Pending',
      date: '2025-12-11',
      description: 'The concept of chemical bonding explained in yesterday\'s class was not clear to me. Could you please explain it again?',
      response: null
    },
    {
      id: 2,
      ...
      status: 'In Progress',
      date: '2025-12-10',
      description: 'I am having difficulty with calculus problems. Can we have an extra doubt clearing session?',
      response: 'I will schedule a doubt session this Friday at 4 PM. Please bring your questions.'
    },
    {
      id: 3,
      student: 'Krish Mehta',
      ...
      status: 'Resolved',
      date: '2025-12-08',
      description: 'I was sick last week and couldn\'t complete the homework. Can I get an extension?',
      response: 'Extension granted until Dec 12. Please submit the work by then. Take care of your health.'
    }
  ];

  const handleAddResponse = () => {
    if (response.trim() && selectedComplaint !== null) {
      alert('Response added successfully! Student and parents will be notified.');
      setResponse('');
    ...
    <div className="space-y-6">
      ...
      <div className="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-lg">
        ...
        <div className="space-y-2 text-gray-700 text-sm">
          ...
          <p>• Update status regularly to keep students and parents informed.</p>
