...
export function UploadCertificates() {
  ...
  const students = [
    'Aarav Patel', 'Aadhya Sharma', 'Advait Kumar', 'Ananya Singh', 
    'Arjun Reddy', 'Diya Gupta', 'Ishaan Verma', 'Kavya Nair'
  ];
  ...
  const handleUpload = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Certificate uploaded successfully! It will appear in the student\'s portfolio.');
    // Reset form
    setSelectedStudent('');
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-gray-900 mb-2">Upload Certificates & Achievements</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <form onSubmit={handleUpload} className="space-y-4">
          ...
          <div>
            <label className="block text-gray-700 mb-2">Upload Certificate File</label>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="space-y-4">
          {uploadedCertificates.map((cert) => (
            <div key={cert.id} className="border border-gray-200 rounded-lg p-6 hover:border-purple-300 transition-colors">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
        ...
        <div className="space-y-2 text-gray-700 text-sm">
          <p>• Uploaded certificates will be immediately visible in the student's portfolio.</p>
          <p>• Ensure certificate files are clear and readable before uploading.</p>
          <p>• Add meaningful remarks to provide context about the achievement.</p>
          <p>• Parents will be notified when a new certificate is added to their child's portfolio.</p>
        </div>
      </div>
    </div>
  );
