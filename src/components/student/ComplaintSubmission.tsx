    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-600">Submit issues and track their resolution status</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-gray-700 mb-2">Department / Teacher</label>
              <input
                type="text"
                value={department}
            ...
            <div key={complaint.id} className="border border-gray-200 rounded-lg p-6">
              ...
              {!complaint.response && (
                <div className="p-4 bg-yellow-50 rounded-lg">
                  <p className="text-sm text-gray-700">
                    Your complaint is being reviewed. You will be notified once there's an update.
                  </p>
                </div>
              )}
            </div>
