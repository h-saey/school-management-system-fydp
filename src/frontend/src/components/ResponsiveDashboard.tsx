...
export function ResponsiveDashboard({
  ...
  const colors =
    colorClasses[roleColor as keyof typeof colorClasses] || colorClasses.blue;
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <SEO title={`${user.name} - ${subtitle || "Dashboard"}`} />
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white shadow-md z-50 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 ${colors.avatar} rounded-full flex items-center justify-center text-white text-sm`}
          >
            {user.name.charAt(0)}
          </div>
          <div>
      ...
      <div className="hidden lg:flex lg:flex-col w-64 bg-white shadow-lg">
        <div className="p-6 border-b">
          <div className="flex items-center gap-3">
            <div
              className={`w-12 h-12 ${colors.avatar} rounded-full flex items-center justify-center text-white`}
            >
              {user.name.charAt(0)}
            </div>
